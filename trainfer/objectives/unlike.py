...
Razin safety (see GLOSSARY.md and ``cont/docs/research/proofs/razin-safety-sharpened.md``):
...
calibration sweep (``cont/docs/research/unlike-defaults-calibration.md``, in
...
# ``cont/docs/research/proofs/razin-safety-sharpened.md`` and the tier-4 upgrade
