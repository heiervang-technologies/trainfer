...
so the loss fits the trainfer per-step interface (single forward/backward, no
    ...
    **_: Any,
    ...
    return {
        ...
        "components": {
            ...
            "n_desirable": sum(1 for label in labels if label == "desirable"),
            "n_undesirable": sum(1 for label in labels if label == "undesirable"),
        },
    }
