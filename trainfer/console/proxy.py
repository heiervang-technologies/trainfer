"""Tiny stdlib-only proxy: serves demo.html at /, forwards /api/* to trainfer on 8765.
...
UPSTREAM = "http://127.0.0.1:" + os.environ.get("TRAINFER_PORT", "8768")
PORT = int(os.environ.get("TRAINFER_PROXY_PORT", "8766"))
...
def main():
    bind = os.environ.get("TRAINFER_PROXY_BIND", "127.0.0.1")
