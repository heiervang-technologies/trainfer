...
Run with: python -m trainfer.tests.test_trajectory_snapshot
"""
...
from trainfer.snapshot import SnapshotManager
from trainfer.state import ModelState
from trainfer.trajectory import TrajectoryLog, new_response_id
