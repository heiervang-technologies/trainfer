...
(``trainfer.objectives.verifiers._logical``) backed by the pinned corpus at
``trainfer/objectives/verifiers/corpora/logical/tasks_v0.json``.
...
from trainfer.objectives.verifiers import VERIFIERS, verify
from trainfer.objectives.verifiers.corpora.logical import get_split, load_tasks
