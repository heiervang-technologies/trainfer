"""Unit tests for trainfer/reasoning.py — streaming ``<think>`` parser.
...
Run with: pytest -xvs trainfer/tests/test_reasoning.py
     or: python -m trainfer.tests.test_reasoning
"""
...
from trainfer.reasoning import (
    ReasoningParser,
