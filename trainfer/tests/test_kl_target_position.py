...
``cont/docs/research/pr-specs/kl-anchor-target-position-scope.md``:
...
from trainfer.objectives.kl import (
    _derive_exclude_ids,
    _sample_text,
    kl_anchor_loss,
)
...
def test_gradient_zero_on_excluded_token_at_target_position() -> None:
    ...
    from trainfer.objectives.kl import _tokenize_prefixes_with_last_idx
