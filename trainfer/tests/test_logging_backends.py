"""Tests for trainfer/logging_backends.py.
...
Run with: python -m trainfer.tests.test_logging_backends
"""
...
from trainfer.logging_backends import (
    LoggerConfig,
    MetricsLogger,
    NullLogger,
    flatten_scalars,
...
def test_get_logger_missing_dep_falls_back_to_null(monkeypatch, caplog):
    ...
    trainfer startup when the user selects a backend whose library isn't
