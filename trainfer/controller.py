...
from .ttrl_mv import TTRLPolicy, TTRLScheduler
...
class Controller:
    def __init__(self, cfg: ServeConfig) -> None:
        ...
        # (the ``trainfer_shutting_down`` gauge) and by every submit_* entrypoint
        ...
        # see ``trainfer/commit_stream.py`` for the bounded-queue + drop-on-full
    ...
    async def submit_train(self, spec: dict[str, Any]) -> dict[str, Any]:
        ...
        if q_ratio > 0.75:
            ...
            metrics.trainfer_queue_depth_high_total.inc()
